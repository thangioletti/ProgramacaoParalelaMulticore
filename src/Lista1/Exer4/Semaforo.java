...
public class Semaforo implements Runnable {
    ...
    public Semaforo(int iCodigoSemaforo, int iEstadoInicial, int iTempoStart){
        ...
        this.aTempos[0] = 10500; //Vermelho
        this.aTempos[1] = 1500; //Amarelo
        this.aTempos[2] = 9000; //Verde
    ...
    public void mudaSemaforo(int iEstado){                
        ...
        if (iSemaforo == 0) {            
            Exer4.Semaforo1.setIcon(oImg);
        } else if (iSemaforo == 1) {
            Exer4.Semaforo2.setIcon(oImg);
        } else if (iSemaforo == 2) {
            Exer4.Semaforo3.setIcon(oImg);
        } else {
            Exer4.Semaforo4.setIcon(oImg);
        }
